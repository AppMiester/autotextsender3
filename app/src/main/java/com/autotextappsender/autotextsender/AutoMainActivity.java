...
//           Gson gson = new Gson();// library to manipulate json data -- read write
//           String json = gson.toJson(Contact.contactArraylist);//serialization gson converting arraylist to json
...
//        SharedPreferences sharedPreferences = getSharedPreferences(Constants.CONTACT_PREFS_FILE, MODE_PRIVATE);
//        Gson gson = new Gson();
